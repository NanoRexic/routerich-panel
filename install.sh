...
if [ "$file_count" -gt 0 ] 2>/dev/null; then
	...
	deploy_file "cgi-bin/zapret2-api" "/www/routerich-panel/cgi-bin/zapret2-api" "755"
	...
	deploy_file "zapret2.js" "/www/routerich-panel/zapret2.js" "644"
	...
	deploy_file "icon-192.png" "/www/routerich-panel/icon-192.png" "644"
	deploy_file "icon-512.png" "/www/routerich-panel/icon-512.png" "644"
	deploy_file "icon-192-solid.png" "/www/routerich-panel/icon-192-solid.png" "644"
	deploy_file "icon-512-solid.png" "/www/routerich-panel/icon-512-solid.png" "644"
	deploy_file "apple-touch-icon.png" "/www/routerich-panel/apple-touch-icon.png" "644"
